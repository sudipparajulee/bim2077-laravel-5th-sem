@extends('layouts.app')
@section('content')
    <h1 class="text-3xl font-bold">Add Notice</h1>
    ...
    <form action="{{route('notice.store')}}" method="POST" class="mt-5">
        ...
        <input type="text" name="notice" placeholder="Enter Notice" class="rounded w-full mt-4" value="{{old('notice')}}">
        @error('notice')
            <span class="text-red-600">* {{$message}}</span>
        @enderror

        <div class="flex justify-center mt-6">
            <button type="submit" class="bg-blue-600 text-white px-4 py-1 rounded mx-2">Add Notice</button>
